...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: 'Youbid — paid product leaderboard' },
      {
        name: 'description',
        content: 'you bid, you get. Bid for a verified place on the Youbid product leaderboard.',
      },
      { property: 'og:title', content: 'Youbid' },
      { property: 'og:description', content: 'you bid, you get' },
